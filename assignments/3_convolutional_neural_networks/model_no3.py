...
#                   regards the removing of the third layer.
#
# USAGE: python model_no3.py
###############################################################################
...
y_hat = tf.nn.softmax(tf.matmul(h_pool2_flat, W_fc2) + b_fc2) # evidence to prob.
...
print "Evaluation of the deep convolutional network without the 3rd layer"
print "=================================================================="
